    ...
    (
      ...
      >
        ...
        >
          ...
          {/* Слоган из Канона, тот же, что на лендинге: в ленте домены стоят
              рядом, и говорить они должны одно. Правило торга остаётся в
              описании под карточкой - на ней самой место для одного. */}
