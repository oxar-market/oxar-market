...
**Варианты заголовка (выбрать один):**

1. `You already own a billboard. You're just not charging rent.`
2. `Your profile is ad space. Start selling it.`
3. `Rent out your avatar. Get paid in USDC.`
...
**Вторая кнопка:** `I want to advertise` → отдельная ветка waitlist
...
Подпись: `The behaviour exists. The infrastructure doesn't.`

---

## 3. Калькулятор: what your account is leaving on the table
...
и расскажет об этом в том же твиттере, где его нашли.
...
Заголовок: `Two hundred spots for the first cohort.`
(число поставить реальное, какое готовы обслужить руками)

Форма собирает:
- X handle
- `I want to sell space` / `I want to buy space`
...
Only if you accept a deal. You approve every request, and you see exactly what would go up.

**What if the advertiser is a scam project?**
You see who's buying and what they want to place before you agree. Reject and nothing happens.

**When do I get paid?**
For the time the placement actually ran. Money is in escrow from the moment the deal is made.
...
- Никаких «AI-powered» и «revolutionizing creator economy».
- Никаких обещаний гарантированных заработков.
- Никаких цифр без источника.
- Не обещать фичи, которых не будет к запуску: кампании корзиной, другие соцсети, физические места.
